    ...
    function initKindergartenOption() {
        ...
        $.get("http://192.168.2.59:8081/test/ajax/getSchool" + "?like=" + $('#like').val(), function (data) {
            if (data.code == 200) {
                ...
                //     list += '<p class="trainSituationSearchResults">' + data[x].park_name +
                //         '<span class="trainSituationSearchResultsClose">×</span></p>';
                // }
                // $('.schoolelist').html(list);
        ...
        series: [{
            ...
            itemStyle: {
                normal: {
                    ...
                    borderColor: "#009fe8", //'#009fe8', //区域边框颜色
