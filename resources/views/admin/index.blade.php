    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{ $train_count }}">0</span>
                    </div>
                    <div class="desc">发布培训</div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                ...
                <div class="details">
                    <div class="number"> +
                        <span data-counter="counterup" data-value="{{ $order_total }}">0</span></div>
