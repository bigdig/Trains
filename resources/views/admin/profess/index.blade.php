            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red sbold uppercase">职称管理</span>
                    </div>
                     <div class="actions">
                         <div class="btn-group">
                             <a href="{{ route('profess.create') }}" class="btn green btn-outline">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                            ...
                            <tbody>
                                @foreach($lists as $list)
                                    <tr id="profess_li_{{$list->id}}">
                                        <td>{{ $list->id }}</td>
                                        <td>{{ $list->professional }}</td>
                                        <td>{{ $list->desc }}</td>
										<td>
											@if($list->profess_type ==1)
												亲子园
											@elseif($list->profess_type ==2)
												幼儿园
											@endif
										</td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="javascript:;" class="btn btn-outline dark btn-sm black mt-sweetalert" style="margin-bottom: 0;" data-title="确定要删除该职称吗？" data-message="" data-type="warning" data-allow-outside-click="true" data-show-cancel-button="true" data-cancel-button-text="点错了" data-cancel-button-class="btn-danger" data-show-confirm-button="true" data-confirm-button-text="确定" data-confirm-button-class="btn-info" data-popup-title-success="删除成功" data-close-on-cancel="true" data-close-on-confirm="false" data-show-loader-on-confirm="true" data-ajax-url="{{ route('profess.destroy',$list->id) }}" data-remove-dom="profess_li_" data-id="{{ $list->id }}">
                                                <i class="fa fa-trash-o"></i>
                                                删除
                                            </a>
                                            <a href="{{ route('profess.edit',$list->id) }}" class="btn btn-outline green btn-sm purple"><i class="fa fa-edit"></i>编辑</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
